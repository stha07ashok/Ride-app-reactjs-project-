...
export function RiderControls({
  ...
  return (
    <div className="p-3 bg-white rounded shadow space-y-3 shadow-lg">
      ...
      <div className="flex gap-2">
        <button
          onClick={onRequest}
          className="flex-1 bg-yellow-500 hover:bg-yellow-600  py-2 rounded shadow-lg"
        >
          Request Ride
        </button>
        <button onClick={onClear} className="flex-1 border rounded py-2 shadow-lg">
          Clear
        </button>
      </div>
    </div>
        ...
        {pending.map((r) => (
          ...
          >
            ...
            <button
              ...
              className="text-sm bg-yellow-500 text-white px-3 py-1 rounded shadow-lg"
            >
              Accept
            </button>
          </div>
